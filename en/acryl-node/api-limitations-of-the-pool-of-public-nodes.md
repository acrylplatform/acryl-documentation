...
**Pool of public nodes** is a set of public [nodes](/blockchain/node.md) which provide data for our products (Acryl Wallet, DEX and others) via REST API [https://nodes.acrylnodes.com](https://nodes.acrylnodes.com/).

You can use our public nodes to retreive the information from Acryl' blockchain, but we recommend you to use your own nodes, because our pool has some limitations listed in the table below.
