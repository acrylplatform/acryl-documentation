...
Here we present a standard that allows the exchange of information about tokens between data providers and applications using the Acryl blockchain.

Any company or individual provider can provide information about tokens, verify/certify projects that have issued a token in the Acryl blockchain. Any application using the Acryl blockchain can use the information provided by the providers.
...
Each provider has its own Acryl address. It can be created specially for the purpose of asset verification or used for other goals as well. 

![](/_assets/acryl_ticker_1.png)
