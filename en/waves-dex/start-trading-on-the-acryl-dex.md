## Start trading on the Acryl DEX

Open up your Acryl wallet.
...
By default, all selected tokens in the ALL section will be adding to the pair with Acryl.
...
**Note**: The trading fee in the **Asset/Asset** pair is **0.003 Acryl**. For **Asset/Smart-asset** pair - **0.007 Acryl** and **Smart-asset/Smart-asset** pair **0.011 Acryl**.
...
> Please beware that Acrylplatform does not provide financial, tax, or legal advice. You should make such decisions on your own or consult with reliable experts_.

___



If you have troubles with our platform, please create a [support](https://support.acrylplatform.com) ticket or write a [question](https://forum.acrylplatform.com) on our forum.
