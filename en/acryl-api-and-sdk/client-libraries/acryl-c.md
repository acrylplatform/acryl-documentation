...
C library for working with Acryl.
...
For a quick start, we took the [bcdev's acryl\_vanity source code](https://github.com/bcdev-/acryl_vanity)source code as a basis.
