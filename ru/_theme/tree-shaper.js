jQuery(document).ready(function () {
	...
	var pathToGithubFile = 'https://github.com/acrylplatform/acryl-documentation/blob/master/';
	...
	var addBranding = function () {
		...
		var $logo = $('<div class="sidebar-brand">' +
			'<a href="/"><img class="brand-logo" src="/_theme/brand-logo/acryls-docs-logo.png"\n' +
			'     srcset="/_theme/brand-logo/acryls-docs-logo@2x.png 2x,\n' +
			'             /_theme/brand-logo/acryls-docs-logo@3x.png 3x"\n alt="Acryls Docs"></a>' +
			'</div>');
